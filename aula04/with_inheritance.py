...
def main() -> None:
    ...
    edu = FreelancerWithCommission(
        name='Edu', id=123, pay_rate=50, hours_worked=100, vat_number=5, commission=1000, contracts_landed=1
    )

    print(
        f"{edu.name} landed {edu.contracts_landed} contracts and earned ${edu.compute_pay()}."
    )

if __name__ == "__main__": # Isso aqui existe para separar o que é definições e declarações de execução de procedimento no código
    main()
